...
export const CATALOG: Product[] = [
  ...
  // Serums / treatments
  { id: "to-niacinamide", brand: "The Ordinary", name: "Niacinamide 10% + Zinc 1%", category: "serum", keyActives: ["niacinamide", "zinc"], targets: ["redness", "evenness", "blemishes"], format: "30 ml serum", priceUsd: 6, blurb: "High-dose niacinamide that calms redness and balances oil.", sourceUrl: "https://theordinary.com/en-us/niacinamide-10-zinc-1-serum-100436.html" },
  { id: "to-azelaic", brand: "The Ordinary", name: "Azelaic Acid Suspension 10%", category: "serum", keyActives: ["azelaic acid"], targets: ["redness", "evenness", "blemishes"], format: "30 ml suspension", priceUsd: 12, blurb: "Brightens uneven tone and calms blemish-prone redness.", sourceUrl: "https://theordinary.com/en-us/azelaic-acid-suspension-10-exfoliator-100407.html" },
